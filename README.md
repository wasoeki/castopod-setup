...
rm -rf .git
git init -b dev
git remote add origin https://$GITHUB_USER:$GITHUB_TOKEN@github.com/wasoeki/castopod-setup.git
secrets-manager -e
git add .
git add **\.enc -f
git commit -m "init"
